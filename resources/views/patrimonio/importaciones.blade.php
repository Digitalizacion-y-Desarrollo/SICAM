...
<div class="mx-auto max-w-[1440px] space-y-5 p-4 sm:p-6 lg:p-8">
    ...
    <div class="grid gap-5 xl:grid-cols-2">
        ...
        <section class="form-card" data-tour="Sube el archivo de la misma categoría. Primero se revisarán los datos; todavía no se crearán bienes." data-tour-title="2. Validar archivo"><h2>2. Cargar y validar</h2>
